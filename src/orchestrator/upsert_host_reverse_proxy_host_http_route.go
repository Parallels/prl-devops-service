...
func (s *OrchestratorService) UpsertHostReverseProxyHostHttpRoute(ctx basecontext.ApiContext, hostId string, rpHostId string, r models.ReverseProxyHostHttpRouteCreateRequest) (*models.ReverseProxyHost, *models.ApiErrorResponse) {
	...
	resp, err := s.CallUpsertHostReverseProxyHostHttpRoute(host, rpHostId, r)
	if err != nil {
		api_error = &models.ApiErrorResponse{
			Message: err.Error(),
			Code:    400,
