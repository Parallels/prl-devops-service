...
type Job struct {
	...
	State              constants.JobState `json:"state" gorm:"column:state;type:varchar(255)"`
	...
	JobType            string             `json:"job_type" gorm:"column:job_type;type:varchar(255)"`
	JobOperation       string             `json:"job_operation" gorm:"column:job_operation;type:varchar(255)"`
	...
	ResultRecordId     string             `json:"result_record_id,omitempty" gorm:"column:result_record_id;type:varchar(255)"`
	ResultRecordName   string             `json:"result_record_name,omitempty" gorm:"column:result_record_name;type:varchar(255)"`
	ResultRecordType   string             `json:"result_record_type,omitempty" gorm:"column:result_record_type;type:varchar(255)"`
