  ...
  - path: /v1/machines
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines");
  ...
  - path: /v1/machines
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/async
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/async' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/async");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/machines/register
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/register' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/register");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/machines/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/machines/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/clone
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/clone' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/machines/{id}/clone");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/machines/{id}/execute
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/execute' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/machines/{id}/execute");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/execute"
              method := "PUT"
  ...
  - path: /v1/machines/{id}/pause
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/pause' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/pause");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/rename
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/rename' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/machines/{id}/rename");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/rename"
              method := "PUT"
  ...
  - path: /v1/machines/{id}/reset
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/reset' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/reset");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/restart
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/restart' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/restart");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/restart"
              method := "GET"
  ...
  - path: /v1/machines/{id}/resume
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/resume' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/resume");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/resume"
              method := "GET"
  ...
  - path: /v1/machines/{id}/set
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/set' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/machines/{id}/set");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/machines/{id}/snapshots
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/snapshots' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/snapshots");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/snapshots"
              method := "GET"
  ...
  - path: /v1/machines/{id}/snapshots
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/{id}/snapshots");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/machines/{id}/snapshots
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/machines/{id}/snapshots");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/snapshots/{snapshot_id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/snapshots/{snapshot_id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/machines/{id}/snapshots/{snapshot_id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/snapshots/{snapshot_id}"
              method := "DELETE"
  ...
  - path: /v1/machines/{id}/snapshots/{snapshot_id}/revert
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/snapshots/{snapshot_id}/revert' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/{id}/snapshots/{snapshot_id}/revert");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/snapshots/{snapshot_id}/revert"
              method := "POST"
  ...
  - path: /v1/machines/{id}/start
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/start' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/start");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/status
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/status' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/status");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/status"
              method := "GET"
  ...
  - path: /v1/machines/{id}/stop
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/stop' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/stop");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/machines/{id}/suspend
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/suspend' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/machines/{id}/suspend");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/suspend"
              method := "GET"
  ...
  - path: /v1/machines/{id}/unregister
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/unregister' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/{id}/unregister");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/unregister"
              method := "POST"
  ...
  - path: /v1/machines/{id}/upload
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/machines/{id}/upload' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/machines/{id}/upload");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/machines/{id}/upload"
              method := "POST"
...
This section contains all machines related endpoints.
