  ...
  - path: /v1/cache
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/cache' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/cache");
  ...
  - path: /v1/cache
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/cache");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/cache/{catalogId}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/cache/{catalogId}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/cache/{catalogId}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/cache/{catalogId}/{version}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/cache/{catalogId}/{version}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/cache/{catalogId}/{version}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/cache/{catalogId}/{version}"
              method := "DELETE"
  ...
  - path: /v1/catalog
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/catalog");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/import
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/import' \
          --header 'Authorization: ******' \
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/catalog/import");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/import-vm
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/import-vm' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/catalog/import-vm");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/pull
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/pull' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/catalog/pull");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/pull/async
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/pull/async' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/catalog/pull/async");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/pull/async"
              method := "PUT"
  ...
  - path: /v1/catalog/push
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/push' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/catalog/push");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/{catalogId}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/catalog/{catalogId}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/{catalogId}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/{catalogId}/{version}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/catalog/{catalogId}/{version}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}"
              method := "GET"
  ...
  - path: /v1/catalog/{catalogId}/{version}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}/{version}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}"
              method := "GET"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/claims
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/claims' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/claims");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/claims"
              method := "DELETE"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/claims
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/claims");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/download
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/download' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/download");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/download"
              method := "GET"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/revoke
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/revoke' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/revoke");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/revoke"
              method := "PATCH"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/roles
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/roles' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/roles");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/roles"
              method := "DELETE"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/roles
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/roles");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/tags
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/tags' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/tags");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/tags"
              method := "DELETE"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/tags
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/tags");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/taint
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/taint' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/taint");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/taint"
              method := "PATCH"
  ...
  - path: /v1/catalog/{catalogId}/{version}/{architecture}/untaint
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/untaint' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Patch, "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/untaint");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/catalog/{catalogId}/{version}/{architecture}/untaint"
              method := "PATCH"
...
This section contains all catalogs related endpoints.
