  ...
  - path: /v1/templates/packer
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/templates/packer' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/templates/packer");
  ...
  - path: /v1/templates/packer
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/templates/packer");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/templates/packer/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/templates/packer/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/templates/packer/{id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/templates/packer/{id}"
              method := "GET"
  ...
  - path: /v1/templates/packer/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/templates/packer/{id}");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/templates/packer/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/templates/packer/{id}");
          request.Headers.Add("Authorization", "******");
...
# Packer Templates API

This section contains all packer templates related endpoints.
