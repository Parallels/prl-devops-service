  ...
  - path: /v1/ws/subscribe
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/ws/subscribe' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/ws/subscribe");
    ...
    response_blocks:
      - code: 101
        code_description: Switching Protocols
        code_block: |
          {
            "message": "string",
  ...
  - path: /v1/ws/unsubscribe
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/ws/unsubscribe' \
          --header 'Authorization: ******' \
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/ws/unsubscribe");
          request.Headers.Add("Authorization", "******");
...
This section contains all events related endpoints.
