  ...
  - path: /v1/auth/claims
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/auth/claims' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/auth/claims");
  ...
  - path: /v1/auth/claims
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/auth/claims");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/auth/claims/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/auth/claims/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/auth/claims/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/auth/claims/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/auth/claims/{id}");
          request.Headers.Add("Authorization", "******");
...
This section contains all claims related endpoints.
