  ...
  - path: /v1/reverse-proxy
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/reverse-proxy");
  ...
  - path: /v1/reverse-proxy/disable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/disable' \
          --header 'Authorization: ******' \
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/reverse-proxy/disable");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/disable"
              method := "PUT"
  ...
  - path: /v1/reverse-proxy/enable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/enable' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/reverse-proxy/enable");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/enable"
              method := "PUT"
  ...
  - path: /v1/reverse-proxy/hosts
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/reverse-proxy/hosts");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts"
              method := "GET"
  ...
  - path: /v1/reverse-proxy/hosts
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/reverse-proxy/hosts");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/reverse-proxy/hosts/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/reverse-proxy/hosts/{id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts/{id}"
              method := "GET"
  ...
  - path: /v1/reverse-proxy/hosts/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/reverse-proxy/hosts/{id}");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/reverse-proxy/hosts/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/reverse-proxy/hosts/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/reverse-proxy/hosts/{id}/http_route
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts/{id}/http_route' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/reverse-proxy/hosts/{id}/http_route");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts/{id}/http_route"
              method := "POST"
  ...
  - path: /v1/reverse-proxy/hosts/{id}/http_routes
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts/{id}/http_routes' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes"
              method := "POST"
  ...
  - path: /v1/reverse-proxy/hosts/{id}/http_routes/order
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/order' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/order");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/order"
              method := "PUT"
  ...
  - path: /v1/reverse-proxy/hosts/{id}/http_routes/{http_route_id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/{http_route_id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/{http_route_id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/hosts/{id}/http_routes/{http_route_id}"
              method := "DELETE"
  ...
  - path: /v1/reverse-proxy/restart
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/reverse-proxy/restart' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/reverse-proxy/restart");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/reverse-proxy/restart"
              method := "PUT"
...
This section contains all reverseproxy related endpoints.
