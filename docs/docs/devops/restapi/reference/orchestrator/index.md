  ...
  - path: /v1/orchestrator/hosts
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/hosts
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/orchestrator/hosts/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/hosts/{id}/catalog/cache
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/catalog/cache' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/catalog/cache
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}"
              method := "DELETE"
  ...
  - path: /v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}/{catalog_version}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}/{catalog_version}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}/{catalog_version}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/catalog/cache/{catalog_id}/{catalog_version}"
              method := "DELETE"
  ...
  - path: /v1/orchestrator/hosts/{id}/disable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/disable' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/disable");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/disable"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/enable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/enable' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/enable");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/enable"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/hardware
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/hardware' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/hardware");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/hardware"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/machines");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/machines");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/register
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/register' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/machines/register");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/register"
              method := "POST"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/clone
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/clone' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/clone");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/clone"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/execute
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/execute' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/execute");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/execute"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/pause
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/pause' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/pause");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/pause"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/rename
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/rename' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/rename");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/rename"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/reset
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/reset' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/reset");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/reset"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/restart
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/restart' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/restart");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/restart"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/resume
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/resume' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/resume");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/resume"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/set
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/set' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/set");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/set"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/start
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/start' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/start");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/start"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/status
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/status' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/status");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/status"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/stop
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/stop' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/stop");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/stop"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/suspend
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/suspend' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/suspend");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/suspend"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/machines/{vmId}/unregister
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/unregister' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/unregister");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/machines/{vmId}/unregister"
              method := "POST"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/disable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/disable' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/disable");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/disable"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/enable
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/enable' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/enable");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/enable"
              method := "PUT"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}"
              method := "GET"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes"
              method := "POST"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes/{route_id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes/{route_id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes/{route_id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/http_routes/{route_id}"
              method := "DELETE"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/tcp_route
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/tcp_route' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/tcp_route");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/hosts/{reverse_proxy_host_id}/tcp_route"
              method := "POST"
  ...
  - path: /v1/orchestrator/hosts/{id}/reverse-proxy/restart
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/restart' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/restart");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/hosts/{id}/reverse-proxy/restart"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/machines");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines"
              method := "GET"
  ...
  - path: /v1/orchestrator/machines
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/orchestrator/machines");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
  ...
  - path: /v1/orchestrator/machines/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/machines/{id}");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}"
              method := "GET"
  ...
  - path: /v1/orchestrator/machines/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/orchestrator/machines/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/orchestrator/machines/{id}/clone
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/clone' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/clone");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{\n  \"key\": \"SomeKey\",\n  \"secret\": \"SomeLongSecret\"\n}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/clone"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/execute
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/execute' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/execute");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/execute"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/pause
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/pause' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/pause");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/pause"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/rename
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/rename' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/rename");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/rename"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/reset
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/reset' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/reset");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/reset"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/restart
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/restart' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/restart");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/restart"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/resume
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/resume' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/resume");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/resume"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/set
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/set' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/set");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/set"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/start
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/start' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/start");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/start"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/status
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/status' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/machines/{id}/status");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/status"
              method := "GET"
  ...
  - path: /v1/orchestrator/machines/{id}/stop
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/stop' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/stop");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/stop"
              method := "PUT"
  ...
  - path: /v1/orchestrator/machines/{id}/suspend
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/machines/{id}/suspend' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/orchestrator/machines/{id}/suspend");
          request.Headers.Add("Authorization", "******");
          request.Content = new StringContent("{}", Encoding.UTF8, "application/json");
          var response = await client.SendAsync(request);
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/machines/{id}/suspend"
              method := "PUT"
  ...
  - path: /v1/orchestrator/overview/resources
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/overview/resources' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/overview/resources");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/overview/resources"
              method := "GET"
  ...
  - path: /v1/orchestrator/overview/{id}/resources
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/orchestrator/overview/{id}/resources' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/orchestrator/overview/{id}/resources");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/orchestrator/overview/{id}/resources"
              method := "GET"
...
This section contains all orchestrator related endpoints.
