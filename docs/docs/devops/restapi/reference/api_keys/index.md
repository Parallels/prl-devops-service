  ...
  - path: /v1/auth/api_keys
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/auth/api_keys' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/auth/api_keys");
  ...
  - path: /v1/auth/api_keys
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Post, "{{host}}/v1/auth/api_keys");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/auth/api_keys/{id}
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/auth/api_keys/{id}' \
          --header 'Authorization: ******'
      - title: C#
        language: csharp
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Get, "{{host}}/v1/auth/api_keys/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/auth/api_keys/{id}
    ...
    example_blocks:
      ...
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Delete, "{{host}}/v1/auth/api_keys/{id}");
          request.Headers.Add("Authorization", "******");
  ...
  - path: /v1/auth/api_keys/{id}/revoke
    ...
    example_blocks:
      - title: cURL
        language: powershell
        code_block: |
          curl --location '{{host}}/v1/auth/api_keys/{id}/revoke' \
          --header 'Authorization: ******' \
          --header 'Content-Type: application/json' \
          --data '{}'
      - title: C#
        ...
        code_block: |
          var client = new HttpClient();
          var request = new HttpRequestMessage(HttpMethod.Put, "{{host}}/v1/auth/api_keys/{id}/revoke");
          request.Headers.Add("Authorization", "******");
      ...
      - title: Go
        ...
        code_block: |
          ...
          func main() {
              url := "{{host}}/v1/auth/api_keys/{id}/revoke"
              method := "PUT"
...
This section contains all api keys related endpoints.
